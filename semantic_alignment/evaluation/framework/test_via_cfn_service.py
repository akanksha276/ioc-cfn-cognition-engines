...
rather than the standalone semantic-alignment app.

The CFN exposes the negotiation API at::

    POST /api/workspaces/{wid}/multi-agentic-systems/{mid}/semantic-alignment/start
    POST /api/workspaces/{wid}/multi-agentic-systems/{mid}/semantic-alignment/decide
...
::
    ...
    cd ioc-cfn-cognitive-agents/semantic_alignment
...
from test_via_semantic_alignment_agents_configured import (
    _AGENT_CONFIGS_FILE,
    _MISSIONS_FILE,
    MISSIONS,
    LocalAgent,
...
async def run(
    ...
    api_base = (
        ...
        f"/multi-agentic-systems/{mas_id}/semantic-alignment"
    )
