...
"""
Dependency injection configuration for the Semantic Alignment Agent.
"""
...
from .agent.semantic_alignment_ce import NegotiationCognitionEngine
from .agent.semantic_alignment import SemanticNegotiationPipeline
