...
Exposes:
    POST /api/workspaces/{workspace_id}/multi-agentic-systems/{mas_id}/semantic-alignment/start
    POST /api/workspaces/{workspace_id}/multi-agentic-systems/{mas_id}/semantic-alignment/decide
...
from ..agent.semantic_alignment_ce import NegotiationAction, NegotiationCognitionEngine
from ..agent.semantic_alignment import (
...
@router.post(
    "/workspaces/{workspace_id}/multi-agentic-systems/{mas_id}/semantic-alignment/start",
...
@router.post(
    "/workspaces/{workspace_id}/multi-agentic-systems/{mas_id}/semantic-alignment/decide",
    status_code=status.HTTP_200_OK,
)
