...
"""Semantic Alignment Cognition Engine.

Wraps :class:`~app.agent.semantic_alignment.SemanticNegotiationPipeline`
...
class NegotiationCognitionEngine(CognitionEngine):
    ...
    Args:
        pipeline: An initialised
            :class:`~app.agent.semantic_alignment.SemanticNegotiationPipeline`.
    """
